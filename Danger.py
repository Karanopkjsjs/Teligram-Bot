...
TOKEN = '7898941604:AAHnvZ_8iCTUKCHw5abB-GU5Ay2hzFdPEVo'
MONGO_URI = 'mongodb+srv://Dangerboyop:FJgjOtOZ2z8kUptY@dangerboyop.nyzgq.mongodb.net/'
FORWARD_CHANNEL_ID = -1002419221987
CHANNEL_ID = -1002419221987
error_channel_id = -1002419221987
...
def create_inline_keyboard():
    ...
    button3 = types.InlineKeyboardButton(
        text="❤‍🩹 𝗝𝗼𝗶𝗻 𝗢𝘂𝗿 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 ❤‍🩹", url="https://t.me/+QOyWVUyW70AwN2Q1")
    button1 = types.InlineKeyboardButton(text="👤 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗢𝘄𝗻𝗲𝗿 👤",
        url="https://t.me/CYBER_X_OWNER")
    markup.add(button3)
    markup.add(button1)
    return markup
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"
                                       ...
                                       "*Please contact the owner for assistance: @CYBER_X_OWNER.*", 
                                       reply_markup=create_inline_keyboard(), parse_mode='Markdown')
            return
